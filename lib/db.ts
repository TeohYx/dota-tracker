...
async function ensureSchema() {
  ...
  // Add notification-related columns to users if missing. SQLite ALTER TABLE
  // ADD COLUMN is permanent so we check first.
...
// Used by cron jobs to find users that should receive notifications.
